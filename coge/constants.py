API_BASE = 'https://geco.iplantcollaborative.org/coge-qa/coge/api/v1/'
...
ENDPOINTS = {'organisms_search': 'organisms/search/',
             ...
             'experiments_fetch': 'experiments/',
             'experiments_add': 'experiments',
             'experiments_update': 'experiments/',
             'experiments_delete': 'experiments/',
             'jobs_fetch': 'jobs/'}
